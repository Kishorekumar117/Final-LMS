...
const Student = () => {
  ...
  const sesId = sessionStorage.getItem('stdId')
  const defaultsesId= sesId ? parseInt(sesId):101;
  const [studentId] = useState(defaultsesId);
  ...
  const studentToShow = data.find(student => student[0] === studentId); // Filter student with ID 1
